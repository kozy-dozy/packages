        ...
        >
            <DropdownMenuContextProvider value={menuControl}>
                <AnimatePresence mode="wait">
                    {!hidden && (
                        <motion.ul
                            // @ts-ignore – framer-motion ref type mismatch. Uses
                            // ts-ignore (not expect-error) so the shared package
                            // tolerates framer-motion/@types/react version drift,
                            // where the ref types may or may not actually clash.
