...
| **nursery** | 🟡 In conversion. Phase 3a: styled foundation wired (coexists w/ Tailwind). Phase 3b: marketing shell (EcomLayout header/nav, AnnouncementBar, ecom Footer) + Home page rebuilt in styled-components (premium editorial). Shop/product/cart/checkout/admin/auth still Tailwind. |
